  ...
  return (
    ...
    >
     <S.CardInner $isFront={isFront}>
        ...
        <S.CardFront>
          <S.CardProfile>
            {imageSource ? <S.SubjectImage src={imageSource} /> : <LogoImg width="120px" height="60px" />}
            <S.SubjectName><span>{name}</span></S.SubjectName>
          </S.CardProfile>
          <S.CardFooter>
            <S.QuestionLabel><MessagesIcon /><span>질문하기</span></S.QuestionLabel>
